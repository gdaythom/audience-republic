  ...
  <div class="event">
    <div class="event__menu">
      ...
      <nav>
        ...
        <a href="#">Import ticket sales</a>
        <a href="#">Edit event details</a>
        <a href="#">Merge event</a>
